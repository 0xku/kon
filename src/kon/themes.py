...
_THEMES: dict[str, ThemeConfig] = {
    ...
    "osaka-jade": ThemeConfig(
        ...
        colors=ColorsConfig(
            ...
            accent="#549e6a",
            info="#2dd5b7",
            markdown_heading="#2dd5b7",
            markdown_code="#63b07a",
            selected="#549e6a",
            error="#ff5345",
            notice="#e5c736",
            diff_added="#63b07a",
            diff_removed="#ff5345",
            tool_bg=ToolBgConfig(pending="#1a2520", success="#15241c", error="#241515"),
            badge=BadgeColorConfig(bg="#1a2520", label="#d2689c"),
            running="#2dd5b7",
            success="#549e6a",
            failed="#ff5345",
            panel="#1a2520",
